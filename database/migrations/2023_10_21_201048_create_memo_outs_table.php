...
return new class extends Migration
{
    ...
    {
        Schema::create('memo_outs', function (Blueprint $table) {
                $table->id();
                $table->date('out_date');    
                ...
                $table->unsignedBigInteger('memo_in_id');
                $table->timestamps();
    
                $table->foreign('user_id')->references('id')->on('users');
                $table->foreign('memo_in_id')->references('id')->on('memo_ins');
            });
        }
